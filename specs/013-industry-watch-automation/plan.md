...
- `docs/industry-watch-sources.json` defines source name, feed URL, credibility, keywords, and impact areas.
...
- Local run: `python3 scripts/industry_watch.py --sources docs/industry-watch-sources.json --out-dir logs/industry --date 2026-06-26 --max-items 8`.
