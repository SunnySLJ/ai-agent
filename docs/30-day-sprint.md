...
- 投递：试投 3 个低风险岗位，观察回复
- 产出：第 1 周复盘
- 行业情报：总结本周 AI Agent/RAG 最新变化，修正第 2 周学习重点
...
- 投递：10 个岗位
- 复盘：哪些 JD 高频词还不熟
- 行业情报：整理本周模型 API、RAG、向量库和评估相关动态，补到面试素材
...
- 投递：15 个岗位
- 行业情报：检查本周 MCP、Agent 框架和企业落地案例是否影响项目讲法
...
- 根据 BOSS 回复修正简历和关键词
- 对照 JD 补最短板
- 汇总 30 天行业情报，提炼 10 条可在面试中引用的趋势判断
