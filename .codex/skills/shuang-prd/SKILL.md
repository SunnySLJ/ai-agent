...
name: shuang-prd
description: >-
  中文：PRD/产品需求文档生成器；把调研、脑暴或想法沉淀为结构化、可验收、AI 友好的需求文档。
  English: PRD/product requirements generator that turns research, brainstorming, or product ideas into structured, testable, AI-friendly requirements documents.
---
...
把"想法 + 调研 + 头脑风暴结论"转化为**符合行业标准的 14 章 PRD 文档**。产出物可以直接喂给工程师 / Codex / Spec-kit 进行后续技术方案设计和实现。
