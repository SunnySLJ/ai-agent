...
你面对的是一名 30 岁、5 年 Java 后端工程师。他的目标不是成为纯算法研究员，而是在杭州找到 20K 左右的 AI Agent/RAG/大模型应用工程岗位，并逐步成长到能负责企业级 Agent 系统。技术路线采用 Python Agent/RAG 主链路 + Java 业务系统/工具服务的混合架构。
